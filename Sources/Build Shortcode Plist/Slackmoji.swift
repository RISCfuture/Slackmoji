let skinTones: Set<Unicode.Scalar> = Set([UInt32(0x1F3FB), UInt32(0x1F3FC), UInt32(0x1F3FD), UInt32(0x1F3FE), UInt32(0x1F3FF)].map { Unicode.Scalar($0)! })
...
struct Slackmoji {
    ...
    private func skinExpansions(codepoints: [Codepoint], insertions: [SkinInsertion], availableSkins: Set<Unicode.Scalar>) -> [[Unicode.Scalar]] {
